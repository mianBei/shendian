...
//	@Autowired
//	JedisUtil jedisUtil;
//	    private final static String USERID="4106";
//	    private final static String ACCOUNT="AC00516";
//	    private final static String PASSWORD="64d14ac342f0b64a6155e2729a6641db";
//	    private final static String SIGN_NAME="【倚云仓商城】";
//
//		public static String genValicodeContent(String code){
//			return "您的验证码："+code+SIGN_NAME;
//		}
//		//查询余额
//		public static StringBuffer SelSum()
//		{
//			StringBuffer sub=new StringBuffer();
//			try {
//				URL url=new URL("http://sh2.cshxsp.com/sms.aspx?action=overage&userid="+USERID+"&account="+ACCOUNT+"&password="+PASSWORD+"");
...
//
//		//发送短信
//		public static StringBuffer SendMessage(String mobile,String content,String sendTime)
//		{
//			StringBuffer sub=new StringBuffer();
//			try {
//				//设置发送内容的编码方式
...
//
//				URL url=new URL("https://dx.ipyy.net/smsJson.aspx?action=send&account="+ACCOUNT+"&password="+PASSWORD+"&mobile="+mobile+"&content="+send_content+"&sendTime="+sendTime+"");
//				HttpURLConnection con = (HttpURLConnection)url.openConnection();
//
//				BufferedReader br=new  BufferedReader(new InputStreamReader(con.getInputStream(),"UTF-8"));
//
...
//		}
//
////		public  HashMap<String,Object> checkAuthCode(HashMap<String,Object> hm){
////			HashMap<String,Object> result = new HashMap<>();
////			String phone = hm.get("phone").toString();
////			String code = hm.get("code").toString();
////			String authCode = jedisUtil.getCache(phone);;
...
////		}
//		//状态报告接口
//		public StringBuffer StatusReport()
//		{
//			StringBuffer sub=new StringBuffer();
//			try {
//				URL url=new URL("http://sh2.cshxsp.com/statusApi.aspx?action=query&userid="+USERID+"&account="+ACCOUNT+"&password="+PASSWORD+"");
//				HttpURLConnection con = (HttpURLConnection)url.openConnection();
//
//				BufferedReader br=new  BufferedReader(new InputStreamReader(con.getInputStream(),"UTF-8"));
//				String line="";
...
//
//		//XML字符串解析通用方法
//		/*public SmsXmlEntity readStringXmlCommen(SmsXmlEntity xmlentity,String xml)
//		{
//			SmsXmlEntity xe=new SmsXmlEntity();
//
//			Document doc=null;
//
//			try {
...
//			String code=Util.genPhoneCode();
//			String sendContent=SmsUtil.genValicodeContent(code);
//			SmsUtil.SendMessage("17602881925", sendContent, "");
//
////			SmsXmlEntity xmlentity=new SmsXmlEntity();
////			String xml=null;
...
//
//		    //发送调用
//		//	xml=t.SendMessage("", "", "wer456", "13621141258", "", "").toString();
